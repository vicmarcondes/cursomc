...
import br.com.marcondes.cursomc.domain.Pagamento;
import br.com.marcondes.cursomc.domain.PagamentoComBoleto;
import br.com.marcondes.cursomc.domain.PagamentoComCartao;
import br.com.marcondes.cursomc.domain.Pedido;
import br.com.marcondes.cursomc.domain.Produto;
import br.com.marcondes.cursomc.domain.enums.EstadoPagamento;
import br.com.marcondes.cursomc.domain.enums.TipoCliente;
...
import br.com.marcondes.cursomc.repositories.EnderecoRepository;
import br.com.marcondes.cursomc.repositories.EstadoRepository;
import br.com.marcondes.cursomc.repositories.ItemPedidoRepository;
import br.com.marcondes.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 = new Categoria(null, "Dormitório");
		Categoria cat5 = new Categoria(null, "Jardinagem");
		Categoria cat6 = new Categoria(null, "Esporte");
		Categoria cat7 = new Categoria(null, "Perfumaria");
		Categoria cat8 = new Categoria(null, "Utensílio");
